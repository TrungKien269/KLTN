        ...
        <div class="col-md-6">
            <form id="signupForm" onSubmit={(e) => handleFormSubmit(e)}>
                ...
                <div class="field-control">
                    ...
                    <input type="password" class="col-md-8"
                ...
                <div class="field-control">
                    <label>Email</label>
                    <input type="email" class="col-md-8" onChange={(e) => handleEmailChanged(e)}
                    />
                </div>

                <div class="field-control">
                    <label>Full Name</label>
                    <input type="text" class="col-md-8" onChange={(e) => handleFullNameChanged(e)}
                    />
                </div>
                <div class="field-control">
                    <label>Gender</label>
                ...
                <div class="field-control">
                    ...
                    <input type="date" class="col-md-8" onChange={(e) => handleBirthdayChanged(e)}
                    />
                </div>
                <div class="field-control">
                    <label>Phone Number</label>
                    <input type="text" class="col-md-8" onChange={(e) => handlePhoneNumberChanged(e)}
                    />
                </div>
                <div class="field-control">
                    <label>Address</label>
                    <input type="text" class="col-md-8" onChange={(e) => handleAddressChanged(e)}
                    />
                </div>
